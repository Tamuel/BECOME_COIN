...
public class CoinTextField extends JTextField implements MouseListener, FocusListener, DocumentListener {
	...
	public CoinTextField(String arg) {
		super(arg);
		custom();
		text = arg;
	}
	...
	private void custom() {
		...
		this.setFont(CoinFont.BIG_FONT);
