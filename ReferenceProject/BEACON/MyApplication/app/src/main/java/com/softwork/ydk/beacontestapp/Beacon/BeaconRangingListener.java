...
public class BeaconRangingListener extends Service implements RECORangingListener {
    ...
    public static int numberOfBeacons = 5;
    public static Map<Integer, Integer> beacons = new HashMap<>();
    ...
    public void didRangeBeaconsInRegion(Collection<RECOBeacon> recoBeacons, RECOBeaconRegion recoRegion) {
        ...
        numberOfBeacons = recoBeacons.size();
        beacons.clear();
        for(RECOBeacon beacon : recoBeacons) {
            beacons.put(beacon.getMinor(), ((int)(beacon.getAccuracy() * 10)) * 10);
//            beaconAvg[beacon.getMinor() / 100 - 1][i] = ((int)(beacon.getAccuracy() * 10)) * 10;
            Log.i("BEA", beacon.getMajor() + " " + beacon.getMinor() + " " + beacon.getAccuracy());
        }
//        i++;
//        if(i == count) {
//            int j;
